...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_FL4] = LAYOUT(
            _______, CK_ON,   NK_ON,   EC_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_U, CK_M_UL, KC_MS_U, CK_M_UR, XXXXXXX, _______,
            _______, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, CK_LL3,  XXXXXXX, XXXXXXX, KC_WH_L, KC_MS_L, XXXXXXX, KC_MS_R, KC_WH_R, _______,
            _______, CK_OFF,  NK_OFF,  XXXXXXX, XXXXXXX, KC_APP,  XXXXXXX, XXXXXXX, KC_WH_D, CK_M_DL, KC_MS_D, CK_M_DR, XXXXXXX, _______,
            _______, QK_BOOT, EE_CLR,  DB_TOGG, XXXXXXX, CK_UNLK, XXXXXXX, KC_BTN2, KC_BTN1, KC_BTN3, XXXXXXX, XXXXXXX, XXXXXXX, _______
            ),
