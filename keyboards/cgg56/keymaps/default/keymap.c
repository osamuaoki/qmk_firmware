...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
            ...
            KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  KC_SPC,  MO(1),   KC_SPC,  KC_SPC,  MO(1),   KC_SPC,  KC_SPC,  KC_RGUI, KC_RALT, KC_RCTL
            ),
    /* ****************************************************************************************************************************************
     * FN-key(s) pressed
     */
    [1] = LAYOUT(
            KC_1,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_GRV,  KC_BSLS, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_1,
            KC_2,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LBRC, KC_RBRC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_2,
            KC_3,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_UNDS, KC_QUOT, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_3,
            KC_4,    KC_5,    KC_6,    KC_SPC,  KC_SPC,  KC_7,    KC_SPC,  KC_SPC,  KC_7,    KC_SPC,  KC_SPC,  KC_6,    KC_5,    KC_4
            ),
};
